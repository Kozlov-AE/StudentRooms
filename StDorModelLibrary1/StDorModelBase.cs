...
namespace StDorModelLibrary
{
    public abstract class StDorModelBase : IStDorModel
    {
        ...
        protected void OnChangedDormitoriesEvent(ImmutableHashSet<DormitoryDTO> dormitories) => ChangedDormitoriesEvent?.Invoke(this, ActionChanged.Change, dormitories);
